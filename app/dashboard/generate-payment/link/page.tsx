  ...
  return (
    <Wrapper>
      <>
        ...
        <p className='text-center py-2'>lnffflflriroieriroeioioddfdfjkjkkjkfjkjfdkjfkjd</p>
        <div className='flex justify-center items-center'>
        ...
        <div className='flex justify-center items-center gap-10 pt-5'>
          <button className='py-3 px-7 bg-orange text-xs text-white rounded-lg'>Share</button>
